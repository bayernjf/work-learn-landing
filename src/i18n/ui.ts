...
export const ui = {
  en: {
    ...
    'cta.remote.caveat': 'Any client that speaks Streamable HTTP can use it. For the ones limited to local stdio, the app offers an installer instead.',
  ...
  zh: {
    ...
    'cta.remote.caveat': '任何支持 Streamable HTTP 的客户端都能直接用。只支持本地 stdio 的，产品里另有安装器。',
    'cta.auto.cta': '登录并接入',
