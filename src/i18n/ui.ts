...
export const ui = {
  en: {
    ...
    'dash.review.title': 'Recall before you check.',
    'dash.review.copy': 'Each review card hides the natural version until you ask for it. Recall it yourself first, then compare.',
    'dash.review.show': 'Show answer',
    'dash.review.mark': 'Mark mastered',
    ...
    'cta.remote.tools': 'Eight tools: create_session · save_material · save_question_translation · search_corpus · get_review_items · mark_mastered · generate_practice · get_user_patterns',
  ...
  zh: {
    ...
    'dash.review.title': '先自己回忆，再展开对照。',
    'dash.review.copy': '每张复习卡片默认藏起地道说法，你先回忆，再对照。',
    ...
    'cta.remote.tools': '8 个工具：create_session · save_material · save_question_translation · search_corpus · get_review_items · mark_mastered · generate_practice · get_user_patterns',
